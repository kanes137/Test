...
public class GroupDataGenerator {
  ...
  @Parameter(names = "-d", description = "Format file")//names указываем у необходимых параметров в конфигурации запуска приложения
  ...
  private List<GroupData> generateGroup(int count) {
    ...
    for (int i = 0; i < count; i++) {
      groups.add(new GroupData().withName(String.format("test1"))
